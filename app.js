...
const translations = {
  ru: {
    ...
    "meta.ogDescription":
      "Семейный автодилер и полноценный автосервис: подержанные авто, финансирование, диагностика, ремонт, гибриды, электрика, эвакуатор и проверка авто перед покупкой.",
    ...
    "hero.salesCall": "Позвонить в отдел продаж / сервис",
    "hero.repairCall": "Позвонить в ремонтный отдел Milford",
    "hero.dealerTitle": "Продажа авто + сервис",
    "hero.dealerText": "Подержанные автомобили, финансирование, ремонт и обслуживание.",
    "hero.locationsTitle": "2 рабочие локации",
    "hero.locationsText": "Продажи/сервис в Cincinnati и ремонтный отдел в Milford.",
    "hero.cardLabel": "Автодилер + автосервис",
    "hero.cardText": "Подержанные авто, финансирование, диагностика, ремонт, гибриды, эвакуатор.",
    "proof.ariaLabel": "Ключевые направления",
    "proof.salesTitle": "Подержанные авто",
    "proof.salesText": "Внедорожники, седаны, премиальные модели и другие автомобили с пробегом.",
    "proof.financeTitle": "Финансирование",
    "proof.financeText": "Варианты финансирования для разных типов кредитной истории.",
    "proof.repairTitle": "Полный автосервис",
    "proof.repairText": "Двигатель, трансмиссия, подвеска, тормоза и обслуживание.",
    "proof.specialTitle": "Специализированные услуги",
    "proof.specialText": "Электрика, блоки управления, ключи, гибриды и эвакуатор.",
    "services.kicker": "Услуги",
    "services.title": "Что делает SIS Motors LLC",
    "services.call": "Позвонить в основную локацию",
    "services.salesTitle": "Продажа подержанных авто",
    "services.salesText": "Качественные автомобили с пробегом: внедорожники, седаны, премиальные модели и другие авто.",
    "services.financeTitle": "Финансирование",
    "services.financeText":
      "Варианты финансирования для разных типов кредитной истории. Для автомобилей указаны бесплатные отчёты CARFAX.",
    "services.engineTitle": "Двигатель и трансмиссия",
    "services.engineText": "Диагностика и ремонт двигателя, ремонт трансмиссии и сложные механические работы.",
    "services.suspensionTitle": "Подвеска и тормоза",
    "services.suspensionText": "Подвеска, тормоза, регулярное обслуживание и замена масла.",
    "services.electricTitle": "Диагностика электрики",
    "services.electricText":
      "Электрика, диагностика, адаптация блоков управления и связанные электронные системы.",
    "services.hybridTitle": "Ремонт гибридных авто",
    "services.hybridText": "Специализированный ремонт гибридных автомобилей.",
    "services.keysTitle": "Автомобильные ключи",
    "services.keysText": "Услуги по автомобильным ключам и связанным системам.",
    "services.roadTitle": "Эвакуатор и проверки",
    "services.roadText": "Эвакуатор, помощь на дороге и проверка автомобиля перед покупкой.",
    "locations.kicker": "Локации",
    "locations.title": "Две точки: Cincinnati и Milford",
    "locations.lead":
      "Основная локация продаж и сервиса находится на Clough Pike в Cincinnati. Отдельный ремонтный отдел находится в Milford на Branch Hill-Guinea Pike, Unit D.",
    "locations.cincinnatiTitle": "Основная локация продаж и сервиса",
    "locations.milfordTitle": "Ремонтный отдел Milford",
    ...
    "inventory.title": "Автомобили с пробегом и финансирование",
    "inventory.photoAlt": "Работы SIS Motors LLC с автомобилем",
    "inventory.heading": "Подержанные автомобили",
    "inventory.text":
      "SIS Motors LLC продаёт надёжные автомобили с пробегом и предлагает варианты финансирования для разных типов кредитной истории. Наличие и цены могут меняться, поэтому их нужно подтверждать напрямую.",
    "inventory.item1": "Внедорожники, седаны и премиальные модели",
    "inventory.item2": "Примеры из объявлений: Honda CR-V, Lexus RX 350, Subaru Forester, Nissan Sentra",
    "inventory.item3": "Для автомобилей указаны бесплатные отчёты CARFAX",
    "inventory.call": "Позвонить по автомобилям",
    "contact.kicker": "Контакты",
    "contact.title": "Связаться с SIS Motors LLC",
    "contact.text":
      "Для покупки автомобиля, финансирования, диагностики, ремонта, эвакуатора или проверки перед покупкой — звоните в подходящую локацию.",
    "contact.mainPhone": "Продажи / сервис",
    "contact.altPhone": "Дополнительный номер продаж",
    "contact.repairPhone": "Ремонтный отдел Milford",
    "contact.cincinnatiAddress": "Адрес Cincinnati",
    "contact.milfordAddress": "Ремонтный отдел Milford",
    "footer.summary": "Семейный автодилер и полноценный автосервис для Cincinnati и Milford.",
    "footer.contactTitle": "Связаться",
    "footer.noteTitle": "Важное",
    "footer.note1": "Наличие авто, цены и часы работы могут меняться.",
    "footer.note2": "Позвоните и подтвердите перед визитом.",
    "footer.note3": "Локация Milford указана как ремонтный отдел."
  },
  en: {
